...
export default function Landing({ onEnter }) {
  return (
    <div className="min-h-screen relative text-slate-100">
      <img src="/bg/landing.jpg" alt="" className="absolute inset-0 w-full h-full object-cover" />
      <div className="absolute inset-0 bg-black/55" />
      <SwordStreakFX />
      <div className="relative z-10 h-screen flex flex-col items-center justify-center px-6 text-center">
        {/* 你的 Logo/標語/按鈕… */}
        <h1 className="text-4xl md:text-5xl font-extrabold tracking-wide mb-4">修仙 · 啟程</h1>
        <button
          onClick={onEnter}
